      ...
      return (
        <div class="fixed inset-0 z-50 bg-slate-900/20 backdrop-blur">
          <div class="flex min-h-full items-center justify-center p-4">
            {/* Modal container */}
            <div class="relative w-full max-w-lg bg-slate-100 rounded-lg shadow-xl overflow-y-auto max-h-[calc(100vh-2rem)]">
              {/* Close button */}
                ...
                <div class="flex flex-col sm:flex-row sm:items-start">
                  ...
                  <div class="text-center sm:ml-4 sm:text-left">
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                      Ensure that the project name matches the folder name of
                      where the images are stored. You can rerun an existing
                      project to update it with any new images added.
                      Additionally,{" "}
                      <span class="text-yellow-600">
                        wait 5+ minutes after first creation before logging in.
                      </span>{" "}
                      The database entries will be created quickly but building
                      the indicies may take some time.
                    </p>
                    ...
                    <p class="mt-2 text-sm text-gray-500">
                      Retrieve the total number of images and the count of
                      completed ones for a specific project.
                    </p>
                    <div class="mt-4 gap-4 flex justify-between">
                      <div class="w-full">
                        <ProjectSelect
